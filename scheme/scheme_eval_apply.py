...
def scheme_apply(procedure, args, env):
    ...
    if isinstance(procedure, BuiltinProcedure):
        ...
        def unroll(args):
            if args is nil:
                return []
            return [args.first] + unroll(args.rest)
        argslist = unroll(args)
        ...
        # BEGIN PROBLEM 9
        "*** YOUR CODE HERE ***"
        current_frame = procedure.env.make_child_frame(procedure.formals, args)
        return eval_all(procedure.body, current_frame)
        # END PROBLEM 9
    elif isinstance(procedure, MuProcedure):
        # BEGIN PROBLEM 11
        "*** YOUR CODE HERE ***"
        current_frame = env.make_child_frame(procedure.formals, args)
        return eval_all(procedure.body, current_frame)
        # END PROBLEM 11
    else:
